...
Route::get("addState", "ArticleController@addState");
...
Route::post('/save-subscription/{id}',function($id, Request $request){
  ...
  $user->notify(new \App\Notifications\GenericNotification("Welcome To Allerin", "You will now get all of our push notifications"));
...
Route::post("/saveNotificationOpen", "APIController@saveNotificationOpen");
