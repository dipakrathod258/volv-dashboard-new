  ...
  <div class="container-fluid">
    ...
    <div class="row justify-content-center">
        <div class="col-sm-offset-3 col-sm-6">
                <h3 style="color: #E8582B;"><b>Reset Password</b></h3>
            <div class="card" style="border: 1px solid #ccc; padding: 5%; border-radius: 25px;background-color: #2B4894;">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="form-group row">
                            <label style="color: #fff;" for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('Confirm Password') }}</label>
