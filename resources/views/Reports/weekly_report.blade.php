...
<div class="container">
    <!-- <div class="row">
        <h3><u>Weekly Reports:</u></h3>
        <em class='text-info'><i class='fa fa-info-circle'></i>&nbsp;Following are the stats for <b>No. of Articles covered weekly in each category</b>.</em>
        <br>
        <br>
    </div>
 -->
