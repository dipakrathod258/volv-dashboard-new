            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                    <div class="thumbnail">
                        <div class="caption text-center" onclick="location.href='#'">
                            <div class="position-relative">
                                <h1>{{ $totalUserCount - ($userEnableNotifCount + $userDisableNotifCount) }}</h1>
                            </div>
                            <h4 id="thumbnail-label">Nofication check unknown</h4>
            ...
            <div class="row">
                ...
                <div class="col-sm-offset-3 col-sm-2">
                    <div class="thumbnail">
                        <div class="caption text-center" onclick="location.href='#'">
                            <div class="position-relative">
                                <h1>{{ $uninstalled_count }}</h1>
                            </div>
                            <h4 id="thumbnail-label">No. of Uninstalled</h4>
                            <div class="thumbnail-description smaller">No os users who uninstalled apps. This includes who are not receiving silent notifications since last 2 months. Users who have no article reads since last 2 months.</div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-2">
                    <div class="thumbnail">
                        <div class="caption text-center" onclick="location.href='#'">
                            <div class="position-relative">
                                <h1>{{ $installed_count }}</h1>
                            </div>
                            <h4 id="thumbnail-label">No. of Notif failed but Installed</h4>
                            <div class="thumbnail-description smaller">No. of users who installed app. This includes users who are not receiving notifications but have at least 1 article read on app in last 2 months.</div>
                        </div>
                    </div>
                </div>    
                ...
                <div class="col-sm-2">
                    <div class="thumbnail">
                        <div class="caption text-center" onclick="location.href='#'">
                            <div class="position-relative">
                                <h1>{{ $no_of_curated_category_saved }}</h1>
                            </div>
                            <h4 id="thumbnail-label">No. of Users curated categories</h4>
                            <div class="thumbnail-description smaller">These are the users who have saved their curatation categories.</div>
                        </div>
                    </div>
                </div>    
<!-- 
