@extends('layouts.app')
@section('title', 'In Progress Articles')
@section('in_progress_internal_css')
...
<div class="container main_section">
  <div class="row">
    <h3 class="text-info"><b><u>In Progress Articles on Volv App:</u></b></h3>
  </div>
  ...
  $(function() {
    ...
    $("#article_table select.article_status").on("change", function() {   
      ...
      if (article_status=="Rollback") {
        $(this).removeClass("btn btn-info btn-success btn-warning btn-danger ")
